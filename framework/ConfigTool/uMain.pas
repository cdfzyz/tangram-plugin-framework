  ...
  begin
    ...
    try
      ...
      begin
        ...
        else showmessage('打开节点出错，未知原因！');
      end;
    finally
      frm_editValue.Free;
    end;
  end
  else showmessage('请先在左边树型选择节点！');
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        else showmessage('删除值出错，未知原因！');
      end
      else showmessage('打开节点时出错，未知原因！');
    end;
  end
  else showmessage('请选择一个值才能删除！');
end;
